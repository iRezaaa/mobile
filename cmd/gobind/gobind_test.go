...
var tests = []struct {
...
}{
	{
		name: "ObjC-Testpkg",
		lang: "objc",
		pkg:  "github.com/iRezaaa/mobile/bind/testdata/testpkg",
	},
	{
		name: "Java-Testpkg",
		lang: "java",
	...
	},
	{
		name:    "Java-Javapkg",
		lang:    "java",
		pkg:     "github.com/iRezaaa/mobile/bind/testdata/testpkg/javapkg",
		goos:    "android",
		reverse: true,
	},
	{
	...
	},
	{
		name: "Go-Cgopkg",
		lang: "go,java,objc",
		pkg:  "github.com/iRezaaa/mobile/bind/testdata/cgopkg",
		goos: "android",
	},
}
...
func testMain(m *testing.M) int {
	...
	if runtime.GOOS != "android" {
		if out, err := exec.Command(goBin(), "build", "-o", bin.Name(), "github.com/iRezaaa/mobile/cmd/gobind").CombinedOutput(); err != nil {
...
func testGobind(t *testing.T, exporter packagestest.Exporter) {
	...
	exported := packagestest.Export(t, exporter, []packagestest.Module{{
		Name:  "github.com/iRezaaa/mobile",
...
type Struct struct{
	...
	exported := packagestest.Export(t, exporter, []packagestest.Module{
		...
		{
			// gobind requires github.com/iRezaaa/mobile to generate code for reverse bindings.
			Name:  "github.com/iRezaaa/mobile",
			Files: packagestest.MustCopyFileTree("../.."),
		},
	})
