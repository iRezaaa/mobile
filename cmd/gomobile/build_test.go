...
func TestAndroidBuild(t *testing.T) {
	...
	cmdBuild.flag.Parse([]string{"github.com/iRezaaa/mobile/example/basic"})
	oldTags := buildTags
...
func TestRegexImportGolangXPackage(t *testing.T) {
	tests := []struct {
		...
		{"ffffffff t github.com/iRezaaa/mobile", "github.com/iRezaaa/mobile", 2},
		{"ffffffff t github.com/example/repo/vendor/github.com/iRezaaa/mobile", "github.com/iRezaaa/mobile", 2},
		{"ffffffff t github.com/example/github.com/iRezaaa/mobile", "", 0},
