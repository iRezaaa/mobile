...
package size // import "github.com/iRezaaa/mobile/event/size"

import (
	"image"

	"github.com/iRezaaa/mobile/geom"
)
...
type Event struct {
	...
	// pixels in a single geom.Pt, from the github.com/iRezaaa/mobile/geom package.
	//
