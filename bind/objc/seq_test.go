...
func testMain(m *testing.M) int {
	...
	if runtime.GOOS != "android" {
		...
		if out, err := exec.Command(gocmd, "build", "-o", gomobileBin, "github.com/iRezaaa/mobile/cmd/gomobile").CombinedOutput(); err != nil {
			log.Fatalf("gomobile build failed: %v: %s", err, out)
		}
		if out, err := exec.Command(gocmd, "build", "-o", gobindBin, "github.com/iRezaaa/mobile/cmd/gobind").CombinedOutput(); err != nil {
...
func TestObjcSeqTest(t *testing.T) {
	runTest(t, []string{
		"github.com/iRezaaa/mobile/bind/testdata/testpkg",
		"github.com/iRezaaa/mobile/bind/testdata/testpkg/secondpkg",
		"github.com/iRezaaa/mobile/bind/testdata/testpkg/simplepkg",
...
func TestObjcSeqBench(t *testing.T) {
	...
	runTest(t, []string{"github.com/iRezaaa/mobile/bind/testdata/benchmark"}, "", "SeqBench.m", "Benchmark.framework", true, true)
}

// TestObjcSeqWrappers runs ObjC test SeqWrappers.m.
func TestObjcSeqWrappers(t *testing.T) {
	runTest(t, []string{"github.com/iRezaaa/mobile/bind/testdata/testpkg/objcpkg"}, "", "SeqWrappers.m", "Objcpkg.framework", false, false)
}

// TestObjcCustomPkg runs the ObjC test SeqCustom.m.
func TestObjcCustomPkg(t *testing.T) {
	runTest(t, []string{"github.com/iRezaaa/mobile/bind/testdata/testpkg"}, "Custom", "SeqCustom.m", "Testpkg.framework", false, false)
}
